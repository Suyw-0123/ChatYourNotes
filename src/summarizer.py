...
"""
        if Config.PROVIDER == 'gemini':
            try:
                ...
                print(f"Error creating final summary (Gemini): {str(e)}")
            ...
            try:
                ...
                print(f"Error creating final summary (OpenAI): {str(e)}")
                return combined_summary
